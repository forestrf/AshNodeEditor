...
namespace Ashkatchap.AIBrain.GeneratedNodes {
	[Serializable]
	[CreateNode("Actuator/UnityEngine/Mathf/FloorToInt (Single f) : Int32")]
	public class GN_UnityEngine_Mathf_FloorToInt_389529E4F9AC198761450D1A29747F79 : Node {
		...
		public override void Calculate() {
			returnVar.SetValue(UnityEngine.Mathf.FloorToInt(f.GetValue()));
		}
