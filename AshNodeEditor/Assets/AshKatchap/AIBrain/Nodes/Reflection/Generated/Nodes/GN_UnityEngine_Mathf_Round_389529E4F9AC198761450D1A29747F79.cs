...
namespace Ashkatchap.AIBrain.GeneratedNodes {
	[Serializable]
	[CreateNode("Actuator/UnityEngine/Mathf/Round (Single f) : Single")]
	public class GN_UnityEngine_Mathf_Round_389529E4F9AC198761450D1A29747F79 : Node {
		...
		public override void Calculate() {
			returnVar.SetValue(UnityEngine.Mathf.Round(f.GetValue()));
		}
