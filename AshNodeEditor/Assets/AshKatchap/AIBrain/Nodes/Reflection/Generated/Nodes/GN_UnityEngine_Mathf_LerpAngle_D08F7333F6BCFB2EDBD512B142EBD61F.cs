...
namespace Ashkatchap.AIBrain.GeneratedNodes {
	[Serializable]
	[CreateNode("Actuator/UnityEngine/Mathf/LerpAngle (Single a, Single b, Single t) : Single")]
	public class GN_UnityEngine_Mathf_LerpAngle_D08F7333F6BCFB2EDBD512B142EBD61F : Node {
		...
		public override void Calculate() {
			returnVar.SetValue(UnityEngine.Mathf.LerpAngle(a.GetValue(), b.GetValue(), t.GetValue()));
		}
