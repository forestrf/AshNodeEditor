...
namespace Ashkatchap.AIBrain.GeneratedNodes {
	[Serializable]
	[CreateNode("Actuator/UnityEngine/Animator/ResetTrigger (Int32 id) : Void")]
	public class GN_UnityEngine_Animator_ResetTrigger_System_Int32 : Node {
		...
		public override void Calculate() {
			(refObject.GetValue() as UnityEngine.Animator).ResetTrigger(id.GetValue());
		}
