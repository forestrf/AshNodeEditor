...
namespace Ashkatchap.AIBrain.GeneratedNodes {
	[Serializable]
	[CreateNode("Actuator/UnityEngine/Mathf/Log (Single f) : Single")]
	public class GN_UnityEngine_Mathf_Log_389529E4F9AC198761450D1A29747F79 : Node {
		...
		public override void Calculate() {
			returnVar.SetValue(UnityEngine.Mathf.Log(f.GetValue()));
		}
