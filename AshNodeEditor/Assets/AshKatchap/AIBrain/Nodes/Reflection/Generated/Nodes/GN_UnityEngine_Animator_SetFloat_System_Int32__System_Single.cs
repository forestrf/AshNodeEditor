...
namespace Ashkatchap.AIBrain.GeneratedNodes {
	[Serializable]
	[CreateNode("Actuator/UnityEngine/Animator/SetFloat (Int32 id, Single value) : Void")]
	public class GN_UnityEngine_Animator_SetFloat_System_Int32__System_Single : Node {
		...
		public override void Calculate() {
			(refObject.GetValue() as UnityEngine.Animator).SetFloat(id.GetValue(), value.GetValue());
		}
