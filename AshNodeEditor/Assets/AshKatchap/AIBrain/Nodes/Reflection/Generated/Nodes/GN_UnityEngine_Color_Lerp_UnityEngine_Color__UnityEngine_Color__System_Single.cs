...
namespace Ashkatchap.AIBrain.GeneratedNodes {
	...
	public class GN_UnityEngine_Color_Lerp_UnityEngine_Color__UnityEngine_Color__System_Single : Node {
		...
		public override void Calculate() {
			returnVar.SetValue(UnityEngine.Color.Lerp(a.GetValue(), b.GetValue(), t.GetValue()));
		}
