...
namespace Ashkatchap.AIBrain.GeneratedNodes {
	[Serializable]
	[CreateNode("Actuator/UnityEngine/Physics/Raycast (Vector3 origin, Vector3 direction, out RaycastHit hitInfo, Single maxDistance) : Boolean")]
	public class GN_UnityEngine_Physics_Raycast_UnityEngine_Vector3__UnityEngine_Vector3__UnityEngine_RaycastHit_Out___System_Single : Node {
...
returnVar.SetValue(UnityEngine.Physics.Raycast(origin.GetValue(), direction.GetValue(), out out_hitInfo, maxDistance.GetValue()));
